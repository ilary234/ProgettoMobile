...
@Database([Category::class, User::class, Recipe::class, UserFavourite::class, UserRated::class], version = 4, exportSchema = false)
...
abstract class ProjectDatabase : RoomDatabase() {
    ...
    abstract fun UserRatedDAO(): UserRatedDAO
}